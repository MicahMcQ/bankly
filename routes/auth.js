...
//  The User.authenticate method seems to be synchronous, but you're treating it as asynchronous by using await. If User.authenticate is not a promise-based function, it won't work as expected.
