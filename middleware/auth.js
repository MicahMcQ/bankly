...
// Instead of setting req.curr_username and req.curr_admin directly in the if (token) block, you should handle the case where the token is invalid separately. Also, it's good to check if payload exists before accessing its properties to avoid potential errors.
